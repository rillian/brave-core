...
class ConfirmationsObserver : public base::CheckedObserver {
 public:
  // Invoked when an ad confirmation was sent
  virtual void OnDidConfirmAd(const double estimated_redemption_value,
                              const ConfirmationInfo& confirmation) {}

  // Invoked when an ad confirmation fails to send
  virtual void OnFailedToConfirmAd(const ConfirmationInfo& confirmation) {}
